...
if __name__ == '__main__':
    ...
    agent.addsim(simagent.clffactory('svm', kernel='linear', decision_function_shape='ovr', gamma=4))
    agent.addsim(simagent.clffactory('svm', kernel='rbf', decision_function_shape='ovr', gamma=4))
    agent.addsim(simagent.clffactory('knn', n_neighbors=1))
